...
class Test(unittest.TestCase):
 ...
 ''' 
    ...
    def test_Introduction_to_Complex_Numbers(self):
        self.driver = webdriver.Chrome(executable_path="C:\chromedriver_win32\chromedriver.exe")
        self.driver.get('file:///D:/Santhosh/VeativeWebVR/Introduction_to_Complex_Numbers/login.html')
        self.driver.implicitly_wait(10)
        self.driver.find_element_by_id("username").send_keys("Sanjeev Desai")
        self.driver.find_element_by_id("age").send_keys("25")
        element = Select(self.driver.find_element_by_name('gender'))
    ...
    def test_Reproductive_Parts_of_a_Flower(self):
        self.driver = webdriver.Chrome(executable_path="C:\chromedriver_win32\chromedriver.exe")
        self.driver.get('file:///D:/Santhosh/VeativeWebVR/Reproductive_Parts_of_a_Flower/login.html')
        self.driver.implicitly_wait(10)
        self.driver.find_element_by_id("username").send_keys("Sanjeev Desai")
        self.driver.find_element_by_id("age").send_keys("25")
        element = Select(self.driver.find_element_by_name('gender'))
    ...
    def test_Opaque_Translucent_and_Transparent(self):
        self.driver = webdriver.Chrome(executable_path="C:\chromedriver_win32\chromedriver.exe")
        self.driver.get('file:///D:/Santhosh/VeativeWebVR/Opaque_Translucent_and_Transparent/login.html')
        self.driver.implicitly_wait(10)
        self.driver.find_element_by_id("username").send_keys("Sanjeev Desai")
        self.driver.find_element_by_id("age").send_keys("25")
        element = Select(self.driver.find_element_by_name('gender'))
    ...
    def test_Series_and_Parallel_Circuits(self):
        self.driver = webdriver.Chrome(executable_path="C:\chromedriver_win32\chromedriver.exe")
        self.driver.get('file:///D:/Santhosh/VeativeWebVR/Series_and_Parallel_Circuits/login.html')
        self.driver.implicitly_wait(10)
        self.driver.find_element_by_id("username").send_keys("Sanjeev Desai")
        self.driver.find_element_by_id("age").send_keys("25")
        element = Select(self.driver.find_element_by_name('gender'))
    ...
    def test_Line_and_Plane_of_Symmetry(self):
        self.driver = webdriver.Chrome(executable_path="C:\chromedriver_win32\chromedriver.exe")
        self.driver.get('file:///D:/Santhosh/VeativeWebVR/Line_and_Plane_of_Symmetry/login.html')
        self.driver.implicitly_wait(10)
        self.driver.find_element_by_id("username").send_keys("Sanjeev Desai")
        self.driver.find_element_by_id("age").send_keys("25")
        element = Select(self.driver.find_element_by_name('gender'))
    ...
    def test_lines(self):
        self.driver = webdriver.Chrome(executable_path="C:\chromedriver_win32\chromedriver.exe")
        self.driver.get('file:///D:/Santhosh/VeativeWebVR/Lines/login.html')
        self.driver.implicitly_wait(10)
        self.driver.find_element_by_id("username").send_keys("Sanjeev Desai")
        self.driver.find_element_by_id("age").send_keys("25")
        element = Select(self.driver.find_element_by_name('gender'))
    ...
    def test_humun_brain(self):
        self.driver = webdriver.Chrome(executable_path="C:\chromedriver_win32\chromedriver.exe")
        self.driver.get('file:///D:/Santhosh/VeativeWebVR/Human_Brain/login.html')
        self.driver.implicitly_wait(10)
        self.driver.find_element_by_id("username").send_keys("Sanjeev Desai")
        self.driver.find_element_by_id("age").send_keys("25")
        element = Select(self.driver.find_element_by_name('gender'))
